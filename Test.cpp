	  ...
	  testcase.CHECK_EQUAL(iterable_to_string(range(1.05, 5.05)),string("1.05,2.05,3.05,4.05,"));
		...
		for (int i : range(0, 0))
			testcase.CHECK_EQUAL(1, 0);
     		...
     		// testcase.CHECK_EQUAL(iterable_to_string(chain(range(0.5, 2.5), string("876"))),string("0.5,1.5,8,7,"));   //invalid!!!
...
// Zip z11 = zip(range('A','E'), string("////"));
// cout << iterable_to_string(z11) << endl;
// Chain c11 = chain(range(-1,1), range(50,52));
// cout << iterable_to_string(c11) << endl;
// Zip z1111 = zip(c11,z11);
// cout << iterable_to_string(z1111) << endl;
